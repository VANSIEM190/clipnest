...
import UserStatus from '../components/UsersStatut'
    ...
    >
      ...
      >
        ...
        <div className="mt-6 flex justify-end space-x-2">
          ...
          {user?.uid.includes(informationsUser.id) && (
            <button
              type="button"
              title="Déconnexion"
